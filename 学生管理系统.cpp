...
int find()
{
	while(1)
	{
		...
		switch(getch())
		{
		case '1':printf("请输入要查找的【学号】\n");findswitch(1);break;
		case '2':printf("请输入要查找的【姓名】\n");findswitch(2);break;
...
int sort()//排序
{
	while(1)
	{
		...
		switch(getch())
		{
		case '1':printf("按照【学号】排序如下：      \n");sortswitch(1);break;
		case '2':printf("按照【姓名(测试)】排序如下：\n");sortswitch(2);break;
		case '3':printf("按照【C语言成绩】排序如下： \n");sortswitch(3);break;
		case '4':printf("按照【英语成绩】排序如下：  \n");sortswitch(4);break;
		case '5':printf("按照【高数成绩】排序如下：  \n");sortswitch(5);break;
		case '6':printf("按照【平均分】排序如下：    \n");sortswitch(6);break;
		case '0':return 0;break;
		default :printf("输入有误！请重新输入。\n");Sleep(500);
		}
	}
...
int save()//保存
{
	...
	while(1)
	{
		...
		if(!(ch=='0'||ch=='1'||ch=='2'))printf("输入有误！请重新输入。\n");
		Sleep(500);
	}
}
